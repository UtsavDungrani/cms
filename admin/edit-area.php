...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $id = intval($_GET['id']);
        $sql = mysqli_query($bd, "update area set city_id='$city_id',areaName='$areaName',pincode='$pincode',updationDate='$currentTime' where id='$id'");
        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3 class="header-title"><i class="icon-edit"></i> Edit Area</h3>
                    ...
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <form class="form-horizontal row-fluid" name="Area" method="post">
                                <?php
                                $id = intval($_GET['id']);
                                $query = mysqli_query($bd, "select * from area where id='$id'");
                                        ...
                                        <div class="controls">
                                            <select name="city_id" class="form-control" required>
                                                ...
                                                while ($city = mysqli_fetch_array($cities)) {
                                                    $selected = ($city['id'] == $row['city_id']) ? 'selected="selected"' : '';
                                                    echo "<option value='" . intval($city['id']) . "' " . $selected . ">" . htmlentities($city['cityName']) . "</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" placeholder="Enter Area Name" name="areaName"
                                                value="<?php echo htmlentities($row['areaName']); ?>" class="form-control"
                                                required>
                                        </div>
                                    </div>
