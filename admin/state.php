...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Admin| Manage States</title>
		...
		<section id="container">
			...
			<section id="main-content">
				<section class="wrapper">
					<h3 class="header-title"><i class="icon-paste"></i> Manage States</h3>
						...
						<div class="module-body">
							...
							<form class="form-horizontal row-fluid" name="Category" method="post">
								...
								<div class="form-group">
									...
									<div class="controls">
										<textarea class="form-control form-textarea" name="description" rows="5"></textarea>
									</div>
								</div>
									...
									while ($row = mysqli_fetch_array($query)) {
										...
										<tr>
											...
											<td class="action-icons">
												<a href="edit-state.php?id=<?php echo $row['id'] ?>" title="Edit"><i
														class="icon-edit"></i></a>
