		...
		<section id="container">
			...
			<section id="main-content">
				<section class="wrapper">
					<h3 class="header-title"><i class="icon-refresh"></i> In Process Complaints</h3>

					<div class="module">
						<div class="module-head">
							<h3>In Process Complaints List</h3>
						</div>
						<div class="module-body table">
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody>
									<?php
									$st = 'in process';
									$query = mysqli_query($bd, "select t.*,u.fullName as name from tblcomplaints t join users u on u.id=t.userId where t.status='$st'");
