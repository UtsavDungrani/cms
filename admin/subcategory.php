...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Admin| Manage SubCategories</title>
		...
		<section id="container">
			...
			<section id="main-content">
				<section class="wrapper">
					<h3 class="header-title"><i class="icon-tasks"></i> Manage SubCategories</h3>
					...
					<div class="module">
						...
						<div class="module-body">
							...
							<form class="form-horizontal row-fluid" name="subcategory" method="post">
								...
								<div class="form-group">
									<label class="form-label" for="basicinput">SubCategory Name</label>
									<div class="controls">
									...
									while ($row = mysqli_fetch_array($query)) {
										...
										<tr>
											...
											<td class="action-icons">
												<a href="edit-subcategory.php?id=<?php echo $row['id'] ?>" title="Edit"><i
														class="icon-edit"></i></a>
