...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($bd, "insert into city(state_id,cityName) values('$state_id','$cityName')");
        $_SESSION['msg'] = "City added Successfully !!";

    }

    if (isset($_GET['del'])) {
        mysqli_query($bd, "delete from city where id = '" . $_GET['id'] . "'");
        ...
        <section id="container">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3 class="header-title"><i class="icon-paste"></i> Manage Cities</h3>
                    ...
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <form class="form-horizontal row-fluid" name="City" method="post">
                                <div class="form-group">
                                    <label class="form-label" for="basicinput">Select State</label>
                                    <div class="controls">
                                        <select name="state_id" class="form-control" required>
                                            <option value="">-- Select State --</option>
                                            <?php
                                            $states = mysqli_query($bd, "SELECT id, stateName FROM state");
                                            while ($state = mysqli_fetch_array($states)) {
                                                echo "<option value='" . intval($state['id']) . "'>" . htmlentities($state['stateName']) . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="basicinput">City Name</label>
                                    <div class="controls">
                    ...
                    <div class="module">
                        ...
                        <div class="module-body table">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($bd, "select c.*, s.stateName from city c LEFT JOIN state s ON c.state_id = s.id");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-icons">
                                                <a href="edit-city.php?id=<?php echo $row['id'] ?>" title="Edit"><i
                                                        class="icon-edit"></i></a>
                                                <a href="city.php?id=<?php echo $row['id'] ?>&del=delete"
