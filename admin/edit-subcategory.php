		...
		<section id="container">
			...
			<section id="main-content">
				<section class="wrapper">
					<h3 class="header-title"><i class="icon-edit"></i> Edit SubCategory</h3>
										...
										<div class="controls">
											<select name="category" class="form-control form-select" required>
												...
												while ($result = mysqli_fetch_array($ret)) {
													...
													if ($catname == $cat) // Fixed comparison operator
													{
														continue;
													} else {
														?>
									...
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" placeholder="Enter SubCategory Name" name="subcategory"
												value="<?php echo htmlentities($row['subcategory']); ?>" class="form-control"
												required>
										</div>
									</div>
